...
GLOBAL_STEP_LIST=(143)
for GLOBAL_STEP in "${GLOBAL_STEP_LIST[@]}";do
    echo "======== Evaluating checkpoint at global step: ${GLOBAL_STEP} ========"
    MODEL_NAME_OR_PATH="/share/goyal/lio/reasoning/model/sky_math8k/r1/Qwen2.5_Math_1.5B_sky_math8k_max_length_4096_bsz_32_epochs_10_checkpoint_64_r1_sky_math8k_rollout_4_max_length_3072_token_budget_314834944/actor/total_token_budget_${GLOBAL_STEP}_steps"
    OUTPUT_DIR="/share/goyal/lio/reasoning/eval/benchmarks/r1/Qwen2.5_Math_1.5B_sky_math8k_max_length_4096_bsz_32_epochs_10_checkpoint_64_r1_sky_math8k_rollout_4_max_length_3072_token_budget_314834944/total_token_budget_${GLOBAL_STEP}_steps"
